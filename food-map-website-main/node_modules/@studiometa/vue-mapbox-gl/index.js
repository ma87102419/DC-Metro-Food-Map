...
import { onMounted as onMounted4, ref as ref3, unref as unref7, computed as computed4 } from "vue";
...
var _sfc_main4 = {
  ...
  setup(__props, { expose, emit }) {
    ...
    onMounted4(() => {
      if (!unref7(map)) {
        unref7(control).addTo(unref7(root));
      }
    });
    expose({ control });
    return (_ctx, _cache) => {
...
var _sfc_main5 = /* @__PURE__ */ Object.assign(__default__, {
  ...
  setup(__props, { expose, emit }) {
    ...
    onMounted5(() => {
      ...
      map.value = new mapboxgl2.Map(options.value);
      map.value.on("load", () => {
        isLoaded.value = true;
      });
...
import { ref as ref7, unref as unref10, watch as watch5, onMounted as onMounted7, onUnmounted as onUnmounted5 } from "vue";
var _hoisted_17 = ["id"];
var propsConfig6 = {
  /**
   * The ID of the image
