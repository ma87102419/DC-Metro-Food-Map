  ...
  <div class="float-container" style="margin-top:-15px;width:100%; height:600px; margin-bottom:-25px;">
    <div class="accordion accordion-flush float-child" style="display:inline-block; width:20%; height: 600px;" id="accordionRestuarants">
      <div style="text-align:center; padding: 5px; border-bottom: 1px solid lightgrey;">
        ...
        :options="restaurants" optionLabel="name"
...
<script>
  ...
  export default {
    components: { Accordion, AccordionTab, Dropdown, DataView, DataViewLayoutOptions, Rating },
    data() {
      return {
    ...
    mounted() {
      ...
      for(var i=0; i<this.restaurants.length; i++){
        this.favoritesID.push(this.restaurants[i].restaurantID);
      }
    },
    methods: {
      createMap(long, lat) {
      ...
      genMap() {
        document.getElementById(`res${this.selectedRestaurant.restaurantID}`).click();
      },
